(function (window) {
    ...
    c3_chart_internal_fn.convertDataToTargets = function (data, appendXs) {
        ...
        targets = ids.map(function (id, index) {
		    ...
		    //console.log("d[id] " + id + " " + JSON.stringify(d[id], null, 4));
			...
			if (typeof obj === 'number' && !isNaN(obj)) {
			    val = obj;
			} else if ( !isUndefined(obj.getValue()) && (typeof obj.getValue() === 'number') && !isNaN(obj.getValue())){
			    val = obj.getValue();
			} 	    
		    ...
		    var returnObj = {x: x, value: val, id: convertedId, orignalData: d[id]};
		    //console.log("return obj " + JSON.stringify(returnObj, null, 4));
    ...
    c3_chart_internal_fn.initTooltip = function () {
        ...
        if (config.tooltip_init_show) {
            ...
            $$.tooltip.html(config.tooltip_contents.call($$, $$(function (d) {
    ...
    c3_chart_internal_fn.getTooltipContent = function (d, defaultTitleFormat, defaultValueFormat, color) {
        ...
        for (i = 0; i < d.length; i++) {
            ...
            value = valueFormat(d[i].value, d[i].ratio, d[i].id, d[i].index, d[i].orignalData);
